...
export const PLANETS: Record<PlanetId, PlanetDef> = {
  verdant: {
    ...
    boss: { kind: "elite", name: "Rax", species: "cryon", power: 4200 },
    npc: {
      name: "Ältester Venn",
      species: "veldari",
  ...
  terra: {
    ...
    boss: { kind: "elite", name: "Einheit Sieben", species: "automata", power: 5600 },
    npc: {
  ...
  cinder: {
    ...
    boss: { kind: "elite", name: "Skarn", species: "thrynn", power: 7200 },
    npc: {
      name: "Schmiedin Oru",
      species: "thrynn",
  ...
  rime: {
    ...
    boss: { kind: "lord", name: "Hohe Veyra", species: "cryon", power: 9800 },
    npc: {
      name: "Läufer Nyx",
      species: "aetheri",
  ...
  aether: {
    ...
    boss: { kind: "lord", name: "Lord Kryll", species: "cryon", power: 14000 },
    npc: {
      name: "Wächterin Aeon",
      species: "aetheri",
